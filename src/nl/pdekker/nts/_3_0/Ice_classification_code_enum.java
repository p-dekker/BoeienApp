...
public class Ice_classification_code_enum implements java.io.Serializable {
    ...
    public static Ice_classification_code_enum fromValue(java.lang.String value)
        ...
        Ice_classification_code_enum enumeration = (Ice_classification_code_enum)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Ice_classification_code_enum.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ris.eu/nts/3.0", "ice_classification_code_enum"));
    }
    /**

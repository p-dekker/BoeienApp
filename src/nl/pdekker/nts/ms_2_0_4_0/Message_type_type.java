...
public class Message_type_type implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6742236914707500463L;
	private java.lang.String _value_;
	private static Map<String, Message_type_type> _table_ = new java.util.HashMap<>();
	...
	public static Message_type_type fromValue(java.lang.String value) throws java.lang.IllegalArgumentException {
		Message_type_type enumeration = _table_.get(value);
		if (enumeration == null) {
	...
	public static Message_type_type fromString(java.lang.String value) throws java.lang.IllegalArgumentException {
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			Message_type_type.class);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ris.eu/nts.ms/2.0.4.0", "message_type_type"));
	}

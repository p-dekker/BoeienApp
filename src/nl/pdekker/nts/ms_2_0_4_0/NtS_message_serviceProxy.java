...
public class NtS_message_serviceProxy implements nl.pdekker.nts.ms_2_0_4_0.NtS_message_service {
	private String _endpoint = null;
	private nl.pdekker.nts.ms_2_0_4_0.NtS_message_service ntS_message_service = null;
	...
	private void _initNtS_message_serviceProxy() {
		try {
			ntS_message_service = (new nl.pdekker.nts.ms_2_0_4_0.NtS_message_service_serviceLocator())
					.getNtS_message_service();
			if (ntS_message_service != null) {
				if (_endpoint != null) {
					((javax.xml.rpc.Stub) ntS_message_service)._setProperty("javax.xml.rpc.service.endpoint.address",
							_endpoint);
				} else {
					_endpoint = (String) ((javax.xml.rpc.Stub) ntS_message_service)

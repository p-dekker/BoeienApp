...
public class Paging_request_type implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1189284358813499817L;
	...
	public Paging_request_type(org.apache.axis.types.NonNegativeInteger offset,
			org.apache.axis.types.NonNegativeInteger limit, boolean total_count) {
		this.offset = offset;
		this.limit = limit;
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof Paging_request_type)) {
			return false;
		}
		...
		_equals = true
				...
				&& ((this.limit == null && other.getLimit() == null)
						|| (this.limit != null && this.limit.equals(other.getLimit())))
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			Paging_request_type.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ris.eu/nts.ms/2.0.4.0", "paging_request_type"));
		...
		elemField.setXmlName(new javax.xml.namespace.QName("http://www.ris.eu/nts.ms/2.0.4.0", "limit"));
		elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "nonNegativeInteger"));
		elemField.setNillable(false);
		typeDesc.addFieldDesc(elemField);
		elemField = new org.apache.axis.description.ElementDesc();

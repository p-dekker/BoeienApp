...
public class Barrage_code_enum implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1530691365465450671L;
	private java.lang.String _value_;
	private static Map<String,Barrage_code_enum> _table_ = new java.util.HashMap<>();
	...
	public static Barrage_code_enum fromValue(java.lang.String value) throws java.lang.IllegalArgumentException {
		Barrage_code_enum enumeration = (Barrage_code_enum) _table_.get(value);
		if (enumeration == null) {
	...
	public static Barrage_code_enum fromString(java.lang.String value) throws java.lang.IllegalArgumentException {
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			Barrage_code_enum.class);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ris.eu/nts/4.0.4.0", "barrage_code_enum"));
	}

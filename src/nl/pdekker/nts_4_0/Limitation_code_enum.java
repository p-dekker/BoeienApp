...
public class Limitation_code_enum implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3092694224008618589L;
	...
	public static final java.lang.String _NOBERT = "NOBERT";
	...
	public static final Limitation_code_enum LEADEP = new Limitation_code_enum(_LEADEP);
	public static final Limitation_code_enum NOBERT = new Limitation_code_enum(_NOBERT);

	public java.lang.String getValue() {
		return _value_;
	}

	public static Limitation_code_enum fromValue(java.lang.String value) throws java.lang.IllegalArgumentException {
		Limitation_code_enum enumeration = (Limitation_code_enum) _table_.get(value);
		if (enumeration == null) {
	...
	public static Limitation_code_enum fromString(java.lang.String value) throws java.lang.IllegalArgumentException {
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			Limitation_code_enum.class);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ris.eu/nts/4.0.4.0", "limitation_code_enum"));
	}

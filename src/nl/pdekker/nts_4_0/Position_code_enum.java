...
public class Position_code_enum implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 852013834727646569L;
	...
	public static final java.lang.String _RY = "RY";
	...
	public static final Position_code_enum RY = new Position_code_enum(_RY);
	public static final Position_code_enum GY = new Position_code_enum(_GY);

	public java.lang.String getValue() {
		return _value_;
	}

	public static Position_code_enum fromValue(java.lang.String value) throws java.lang.IllegalArgumentException {
		Position_code_enum enumeration = (Position_code_enum) _table_.get(value);
		if (enumeration == null) {
	...
	public static Position_code_enum fromString(java.lang.String value) throws java.lang.IllegalArgumentException {
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			Position_code_enum.class);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ris.eu/nts/4.0.4.0", "position_code_enum"));
	}

...
public class Reference_code_enum implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1471954897272724598L;
	...
	public static final java.lang.String _HBO = "HBO";
	...
	public static final Reference_code_enum HBO = new Reference_code_enum(_HBO);

	public java.lang.String getValue() {
		return _value_;
	}

	public static Reference_code_enum fromValue(java.lang.String value) throws java.lang.IllegalArgumentException {
		Reference_code_enum enumeration = (Reference_code_enum) _table_.get(value);
		if (enumeration == null) {
	...
	public static Reference_code_enum fromString(java.lang.String value) throws java.lang.IllegalArgumentException {
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			Reference_code_enum.class);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ris.eu/nts/4.0.4.0", "reference_code_enum"));
	}

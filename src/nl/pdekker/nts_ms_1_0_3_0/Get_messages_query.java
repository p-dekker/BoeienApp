...
public class Get_messages_query  implements java.io.Serializable {
    private nl.pdekker.nts_ms_1_0_3_0.Message_type_type message_type;

    private java.lang.String[][] ids;

    private nl.pdekker.nts._3_0.Validity_period_type validity_period;

    private nl.pdekker.nts_ms_1_0_3_0.Date_pair[] dates_issue;

    private nl.pdekker.nts_ms_1_0_3_0.Paging_request_type paging_request;

    public Get_messages_query() {
    }

    public Get_messages_query(
           nl.pdekker.nts_ms_1_0_3_0.Message_type_type message_type,
           java.lang.String[][] ids,
           nl.pdekker.nts._3_0.Validity_period_type validity_period,
           nl.pdekker.nts_ms_1_0_3_0.Date_pair[] dates_issue,
           nl.pdekker.nts_ms_1_0_3_0.Paging_request_type paging_request) {
     ...
     * @return message_type
     */
    public nl.pdekker.nts_ms_1_0_3_0.Message_type_type getMessage_type() {
        return message_type;
    }
     ...
     * @param message_type
     */
    public void setMessage_type(nl.pdekker.nts_ms_1_0_3_0.Message_type_type message_type) {
        this.message_type = message_type;
    }
     ...
     * @return dates_issue
     */
    public nl.pdekker.nts_ms_1_0_3_0.Date_pair[] getDates_issue() {
        return dates_issue;
    }
     ...
     * @param dates_issue
     */
    public void setDates_issue(nl.pdekker.nts_ms_1_0_3_0.Date_pair[] dates_issue) {
        this.dates_issue = dates_issue;
    }

    public nl.pdekker.nts_ms_1_0_3_0.Date_pair getDates_issue(int i) {
        return this.dates_issue[i];
    }

    public void setDates_issue(int i, nl.pdekker.nts_ms_1_0_3_0.Date_pair _value) {
     ...
     */
    public nl.pdekker.nts_ms_1_0_3_0.Paging_request_type getPaging_request() {
        return paging_request;
    }
     ...
     */
    public void setPaging_request(nl.pdekker.nts_ms_1_0_3_0.Paging_request_type paging_request) {
        this.paging_request = paging_request;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Get_messages_query)) return false;
        ...
        _equals = true && 
            ...
            ((this.dates_issue==null && other.getDates_issue()==null) || 
             (this.dates_issue!=null &&
              java.util.Arrays.equals(this.dates_issue, other.getDates_issue()))) &&
            ((this.paging_request==null && other.getPaging_request()==null) || 
             (this.paging_request!=null &&
              this.paging_request.equals(other.getPaging_request())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getDates_issue() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getDates_issue());
                 i++) {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Get_messages_query.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ris.eu/nts.ms/1.0.3.0", ">get_messages_query"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("message_type");
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.ris.eu/nts.ms/1.0.3.0", "message_type"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.ris.eu/nts.ms/1.0.3.0", "message_type_type"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("ids");
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.ris.eu/nts.ms/1.0.3.0", "ids"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.ris.eu/nts.ms/1.0.3.0", "id_pair"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.ris.eu/nts.ms/1.0.3.0", "validity_period"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.ris.eu/nts.ms/1.0.3.0", "dates_issue"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.ris.eu/nts.ms/1.0.3.0", "date_pair"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.ris.eu/nts.ms/1.0.3.0", "paging_request"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.ris.eu/nts.ms/1.0.3.0", "paging_request_type"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
